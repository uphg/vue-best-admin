import XFilterTable from '@/components/ui/x-filter-table/x-filter-table'

const SortTablePage = defineComponent(() => {
  const data = {
    columns: [{ title: 'ID' }, { title: '姓名' }, { title: '年龄' }, { title: '性别' }, { title: '城市' }, { title: '职业' }, { title: '薪资' }, { title: '入职日期' }, { title: '部门' }, { title: '绩效评分' }, { title: '邮箱' }, { title: '电话' }],
    rows: [
  ...
  return () => (
    <XFilterTable data={data}></XFilterTable>
  )
})
