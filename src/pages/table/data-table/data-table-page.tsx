import { NButton, NCard, NDataTable, NFlex, NForm, NFormItemGi, NGrid, NIcon, NInput, NPagination, NSelect, NSpace, NTag } from 'naive-ui'
...
const DataTablePage = defineComponent(() => {
  ...
  const visibleColumnKeys = ref<string[]>(['id', 'name', 'email', 'role', 'status', 'createdAt', 'actions'])
        ...
        <NCard>
          <NSpace vertical>
            ...
            <div class="flex justify-between">
              ...
              <ColumnSelector v-model:value={visibleColumnKeys.value} columns={allColumns} />
            </div>
