...
export function renderFields(fields, itemsNodeMap, isGrid) {
...
export function createItemNodeMap(fields, form) {
      ...
      case 'checkbox-group': {
        ...
        InputElement = () => (
          <NCheckboxGroup
            ...
            {...otherProps}
          >
            {processOptions(options)?.map((option) => (
...
export function createDefaultField(flattenedFields) {
  const defaultField = {}
...
export function createFormRules(fields, options = {}) {
  const rules = {}
