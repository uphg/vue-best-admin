...
export const customOptionNames = ['autoRules', 'grid']
export const nFormItemPropNames = ['showFeedback', 'showLabel', 'showRequireMark', 'requireMarkPlacement', 'labelPlacement', 'labelAlign', 'labelStyle', 'labelProps', 'labelWidth', 'first', 'ignorePathChange', 'rulePath', 'rule', /* GridItemProps */ 'offset', 'span', 'suffix']
