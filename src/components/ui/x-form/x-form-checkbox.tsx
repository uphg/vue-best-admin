      ...
      <NFormItem {...formItemProps}>
        ...
        >
          {props.options?.map((option: any) => (
            <NCheckbox key={option.value} value={option.value} {...option}>
              {option.label}
            </NCheckbox>
          ))}
        </NCheckboxGroup>
