...
import type { XFormDatePickerBaseProps } from './types'
import { extractFormItemProps, generatePlaceholder, mergeDefaultProps } from './utils'

const XFormDatePicker = defineComponent<XFormDatePickerBaseProps>({
  ...
  setup(props, { emit }) {
    ...
    // 日期选择器属性（排除 value、placeholder 和事件处理）
    ...
    // 处理值更新
    const handleUpdateValue = (value: number | string | null) => {
