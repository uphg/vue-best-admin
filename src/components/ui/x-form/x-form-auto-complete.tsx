...
import type { XFormAutoCompleteBaseProps } from './types'
import { extractFormItemProps, generatePlaceholder, mergeDefaultProps } from './utils'

const XFormAutoComplete = defineComponent<XFormAutoCompleteBaseProps>({
  ...
  setup(props, { emit }) {
    ...
    // 自动完成属性（排除 value、placeholder、options 和事件处理）
